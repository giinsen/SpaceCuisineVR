// Upgrade NOTE: upgraded instancing buffer 'HologramV2Z' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hologram V2 Z"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(HologramV2Z)
			UNITY_DEFINE_INSTANCED_PROP(float4, _FresnelColor)
#define _FresnelColor_arr HologramV2Z
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
#define _Color_arr HologramV2Z
			UNITY_DEFINE_INSTANCED_PROP(float, _Scnaline2Amount)
#define _Scnaline2Amount_arr HologramV2Z
			UNITY_DEFINE_INSTANCED_PROP(float, _Scanline1Amount)
#define _Scanline1Amount_arr HologramV2Z
			UNITY_DEFINE_INSTANCED_PROP(float, _Scanline1Speed)
#define _Scanline1Speed_arr HologramV2Z
		UNITY_INSTANCING_BUFFER_END(HologramV2Z)

		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			UNITY_INITIALIZE_OUTPUT( Input, o );
			float3 ase_vertex3Pos = v.vertex.xyz;
			float temp_output_7_0 = ( ase_vertex3Pos.z + _SinTime.y );
			float mulTime19 = _Time.y * 3.0;
			float3 appendResult37 = (float3(0.0 , 0.0 , ( 0.0 + ( ( ( ( ( step( 0.0 , temp_output_7_0 ) * step( temp_output_7_0 , 0.2 ) ) * 0.1 ) * step( 0.98 , sin( mulTime19 ) ) ) * _SinTime.w ) * 2.5 ) )));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_45_0 = frac( ( ( ase_vertex3Pos.z * _Scanline1Amount_Instance ) + mulTime43 ) );
			float _Scnaline2Amount_Instance = UNITY_ACCESS_INSTANCED_PROP(_Scnaline2Amount_arr, _Scnaline2Amount);
			float temp_output_52_0 = frac( ( ( ase_vertex3Pos.z * _Scnaline2Amount_Instance ) - ( _Time.y * 0.19 ) ) );
...
/*ASEBEGIN
Version=15401
273.6;92.8;646;589;1832.175;-810.3554;2.042608;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-822.2693,2201.427;Float;False;Constant;_Float6;Float 6;4;0;Create;True;0;0;False;0;0.19;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;273.4023,-226.3208;Float;False;Constant;_Float9;Float 9;5;0;Create;True;0;0;False;0;2.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;59;-459.8393,734.5204;Float;False;InstancedProperty;_Color;Color;3;0;Create;True;0;0;False;0;0.6179246,1,1,1;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PosVertexDataNode;38;1109.106,-843.327;Float;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;80.6776,-844.813;Float;False;Constant;_Float5;Float 5;0;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1793.543,-462.4417;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Hologram V2 Z;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;-1;False;-1;-1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=9E6DAEAE6122F7AEFB22AA1E00A22578F762B371